...
${SCRIPT_DIR}/add2systemd -n pytonv3 -s "/usr/bin/python3 -m pyTON --liteserverconfig /usr/bin/ion/local.config.json --libtonlibjson /usr/bin/ion/tonlib/libtonlibjson.so" -u ${user} -g ${user}
